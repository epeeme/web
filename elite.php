...
<html lang="en">
  <head>
    ...
    <title>epee.me - Elite Epee Series Rankings</title>
    <style>
        .mainFilters {
            display:inline;
        }
        @media screen and (max-width: 800px) {
            ...
            /*.season, #getRankButton { float:right; }            */
  ...
  <body>
                ...
                <div class="no-gutters col-12 dataTables_length" style="padding-bottom:10px;">
                    <div style="border-bottom:2px solid #ddd; margin-bottom:10px;">
                        <div style="margin-top:-0.2em;border-bottom:1px solid #ddd; margin-bottom:20px;">
                            <span><img style="height:50px; margin-left:-12px;" class="logo" src="img/eliteEpeeLogo.png" alt="Elite Epee"></span>
                            <p>Ranking and results data for the <a title="Official Elite Epee web site" target="_blank" href="http://www.eliteepee.com/">Elite Epee Series</a> of events. The top 8 available fencers are invited to attend the Grand Final which takes place in December.</p>
                        </div>
    ...
    <script src="scripts/eliteEpee.js"></script>
    <script>
