...
<html lang="en">
  <head>
    ...
    <title>epee.me - FIE Junior World Cup Event Performance Analysis</title>
    <style>
    th {
        position: relative;
        min-height: 41px;
                ...
                <div class="no-gutters col-12 dataTables_length" style="padding-bottom:10px;">
                    <div style="border-bottom:2px solid #ddd; margin-bottom:10px;">
                        <div style="margin-top:-0.2em;border-bottom:1px solid #ddd; margin-bottom:20px;">
                            <p>Performance analysis of every FIE Junior World Cup event since 2005.</p>
                        </div>
                        <div class="extra-fields demographics" style="margin-bottom:20px; margin-left: 0.5em;">
                            ...
                            <button id="getEventHistoryButton" type="button" class="btn btn-primary"> Go! </button>
                            </div>
                            </form>
                        </div>
                    </div>
