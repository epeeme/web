...
<html lang="en">
  <head>
    ...
    <title>epee.me - Leon Paul Junior Series (LPJS) Rankings</title>
    <style>
        .mainFilters {
            display:inline;
        }
  ...
  <body>
                ...
                <div class="no-gutters col-12 dataTables_length" style="padding-bottom:10px;">
                    <div style="border-bottom:2px solid #ddd; margin-bottom:10px;">
                        <div style="margin-top:-0.2em;border-bottom:1px solid #ddd; margin-bottom:20px;">
                            ...
                            <p>Ranking and results data for the Leon Paul Junior Series (LPJS) events. Official Leon Paul Junior Series Web Site - <a target="blank" href="http://leonpauljuniorseries.co.uk/">http://leonpauljuniorseries.co.uk/</a></p>
                        </div>
    ...
    <script src="scripts/lpjs.js"></script>
    <script>
        $(document).ready(function() {
            ...
            if ((season) && (age) && (sex)) {
                ...
                $('select[name="season"]').on('change', function() {
                    if (parseInt(this.value) <= '2014') {
                        $('select[name="cat"]').append('<option value="u17">U17</option>');                     
                    } else {
                        $('select[name="cat"] option[value="u17"]').remove();
                    }
                });
            }
        });        
