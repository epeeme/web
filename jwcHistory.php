...
<html lang="en">
  <head>
    ...
    <title>epee.me - JWC Performance Analysis</title>
    <style>
    th {
        position: relative;
        min-height: 41px;
                ...
                <div class="no-gutters col-12 dataTables_length" style="padding-bottom:10px;">
                    <div style="border-bottom:2px solid #ddd; margin-bottom:10px;">
                        <div style="margin-top:-0.2em;border-bottom:1px solid #ddd; margin-bottom:20px;">
                            ...
                            <p>Performance analysis of every junior fencer that has competed in a JWC event since 2008 broken down by season and country. Results are expressed as a percentage finishing position - <code>(100 / entries) * finishing position</code> - and heat mapped for improved visual representation.</p>
                        </div>
